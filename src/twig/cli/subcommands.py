...
def get_parser_filter_concat(parser: ArgumentParser | None = None) -> ArgumentParser:
    ...
    # actions
    # parser.add_argument("-x", "--nexus", action="store_true", help="export in NEXUS format. Retains path/tree names")
    parser.add_argument("-c", "--concatenate", action="store_true", help="concatenate alignments to create a supermatrix with missing=N")
    parser.add_argument("-s", "--subsample-genes", type=Path, metavar="path", help="subsample to include only genes in this list")
